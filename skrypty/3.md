...
*W tym samouczku pokazane zostaną podstawy zapamiętywania przez Arduino informacji przy pomocy jednostek pamięci zwanych __zmiennymi__, a także podstaw komunikacji z komputerem przy pomocy dołączonego kabla USB.*
...
Ufff... Jak widać, program zawiera bardzo dużo pisania i wiele powtórzeń. Stąd też cały program aż prosi się o to, aby go uprościć - i uproszczenia te są częscią programowania. W następnych skryptach pokazane zostanie, w jaki sposób można upraszczać tak wielkie bloki kodu do bardziej przyjaznej dla człowieka postaci.
